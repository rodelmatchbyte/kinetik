...
namespace System.Threading
{
    ...
    public sealed class Thread : CriticalFinalizerObject, _Thread
    {
        ...
        get; [SecuritySafeCritical, TargetedPatchingOptOut("Performance critical to inline across NGen image boundaries"), SecurityPermission(SecurityAction.Demand, Flags = SecurityPermissionFlag.ControlPrincipal)]
        set; }
